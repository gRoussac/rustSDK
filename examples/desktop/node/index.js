...
const casper_rust_wasm_sdk_1 = require("casper-rust-wasm-sdk");
const fs = require('fs').promises;
const http = require('http');
const rpc_address = 'http://localhost:11101';
const node_address = 'localhost:28101';
const sdk = new casper_rust_wasm_sdk_1.SDK(rpc_address, node_address);
...
const example1 = async () => {
    const transaction_hash_as_string = '27d81df41801602f47cdb4618a814407daf38d0c39be32c7f6c109d7e39a3f4b';
...
const example5 = async () => {
    ...
    const public_key = '01aff5c18a954604dd27d139d8e0cfc533ac3d53784d76c7a7ac5ff4039510fdf6';
    const secret_key = undefined;
    const timestamp = (0, casper_rust_wasm_sdk_1.getTimestamp)(); // or Date.now().toString(); // or undefined
    const ttl = '1h'; // or undefined
    const payment_amount = '100000000';
    const transfer_amount = '2500000000';
    const target_account = '01868e06026ba9c8695f6f3bb10d44782004dbc144ff65017cf484436f9cf7b0f6';
    const transaction_params = new casper_rust_wasm_sdk_1.TransactionStrParams(chain_name, public_key, secret_key, timestamp, ttl);
    transaction_params.payment_amount = payment_amount;
    const make_transfer_transaction = sdk.make_transfer_transaction(undefined, // Optional maybe_source
...
const example6 = async () => {
    ...
    const sdk = new casper_rust_wasm_sdk_1.SDK(rpc_address);
    const chain_name = 'casper-net-1';
    const secret_key = `-----BEGIN PRIVATE KEY-----
MC4CAQAwBQYDK2VwBCIEII8ULlk1CJ12ZQ+bScjBt/IxMAZNggClWqK56D1/7CbI
-----END PRIVATE KEY-----`;
    const public_key = (0, casper_rust_wasm_sdk_1.publicKeyFromSecretKey)(secret_key);
    const timestamp = (0, casper_rust_wasm_sdk_1.getTimestamp)(); // or Date.now().toString(); // or undefined
    const ttl = '1h'; // or undefined
    const payment_amount = '100000000';
    const transfer_amount = '2500000000';
    ...
    const transaction_params = new casper_rust_wasm_sdk_1.TransactionStrParams(chain_name, public_key, secret_key, timestamp, ttl);
    transaction_params.payment_amount = payment_amount;
    const transfer_transaction_result = await sdk.transfer_transaction(undefined, // Optional maybe_source
    target_account, transfer_amount, transaction_params);
...
const example7 = async () => {
    ...
    const entity_hash_hex_string = '5be5b0ef09a7016e11292848d77f539e55791cb07a7012fbc336b1f92a4fe743';
    const entry_point = 'set_variables';
    const transaction_params = new casper_rust_wasm_sdk_1.TransactionStrParams(chain_name, public_key);
    transaction_params.payment_amount = payment_amount;
    let entity_hash = new casper_rust_wasm_sdk_1.AddressableEntityHash(entity_hash_hex_string);
...
-----END PRIVATE KEY-----`;
    ...
    const entity_hash_hex_string = '5be5b0ef09a7016e11292848d77f539e55791cb07a7012fbc336b1f92a4fe743';
    const entry_point = 'set_variables';
    const transaction_params = new casper_rust_wasm_sdk_1.TransactionStrParams(chain_name, public_key, secret_key);
    transaction_params.payment_amount = payment_amount;
    let entity_hash = new casper_rust_wasm_sdk_1.AddressableEntityHash(entity_hash_hex_string);
    let builder_params = casper_rust_wasm_sdk_1.TransactionBuilderParams.newInvocableEntity(entity_hash, entry_point);
...
-----END PRIVATE KEY-----`;
    const public_key = (0, casper_rust_wasm_sdk_1.publicKeyFromSecretKey)(secret_key);
    const payment_amount = '5000000000';
    const entity_hash_formatted_string = 'addressable-entity-5be5b0ef09a7016e11292848d77f539e55791cb07a7012fbc336b1f92a4fe743';
    const entry_point = 'set_variables';
    const transaction_params = new casper_rust_wasm_sdk_1.TransactionStrParams(chain_name, public_key, secret_key);
    transaction_params.payment_amount = payment_amount;
    let entity_hash = casper_rust_wasm_sdk_1.AddressableEntityHash.fromFormattedStr(entity_hash_formatted_string);
    let builder_params = casper_rust_wasm_sdk_1.TransactionBuilderParams.newInvocableEntity(entity_hash, entry_point);
    const transaction = casper_rust_wasm_sdk_1.Transaction.newSession(builder_params, transaction_params);
...
-----END PRIVATE KEY-----`;
    ...
    const transfer_amount = '2500000000';
    const target_account = '01868e06026ba9c8695f6f3bb10d44782004dbc144ff65017cf484436f9cf7b0f6';
    const transfer_params = new casper_rust_wasm_sdk_1.TransactionStrParams(chain_name, public_key, secret_key);
    transfer_params.payment_amount = payment_amount;
    const transfer_transaction = casper_rust_wasm_sdk_1.Transaction.newTransfer(undefined, // optional maybe_source
    target_account, transfer_amount, transfer_params, undefined // optional transfer_id
    );
...
MC4CAQAwBQYDK2VwBCIEII8ULlk1CJ12ZQ+bScjBt/IxMAZNggClWqK56D1/7CbI
-----END PRIVATE KEY-----`;
    const initiator_addr = (0, casper_rust_wasm_sdk_1.publicKeyFromSecretKey)(secret_key);
    const transaction_params = new casper_rust_wasm_sdk_1.TransactionStrParams(chain_name, initiator_addr, secret_key);
    ...
    const cost = eventParseResult.body?.transaction_processed?.execution_result.Success
        ?.cost;
...
-----END PRIVATE KEY-----`;
    ...
    const transaction_hash_results = [
        call_entrypoint_result_as_json.transaction_hash,
    ];
    const watcher = sdk.watchTransaction(events_address);
    const Subscriptions = [];
    const getEventHandlerFn = (transactionHash) => {
        const eventHandlerFn = (eventParseResult) => {
    ...
    transaction_hash_results.map(async (transaction_hash) => {
        ...
        console.log(transaction_hash);
        const subscription = new casper_rust_wasm_sdk_1.Subscription(transaction_hash, eventHandlerFn);
...
-----END PRIVATE KEY-----`;
    const initiator_addr = (0, casper_rust_wasm_sdk_1.publicKeyFromSecretKey)(secret_key);
    const transaction_params = new casper_rust_wasm_sdk_1.TransactionStrParams(chain_name, initiator_addr);
    transaction_params.payment_amount = payment_amount;
    let entity_hash = casper_rust_wasm_sdk_1.AddressableEntityHash.fromFormattedStr(entity_hash_formatted_string);
    let builder_params = casper_rust_wasm_sdk_1.TransactionBuilderParams.newInvocableEntity(entity_hash, 'set_variables');
    const transaction = sdk.make_transaction(builder_params, transaction_params);
...
const example14 = async () => {
    ...
    const transaction_params = new casper_rust_wasm_sdk_1.TransactionStrParams(chain_name, public_key_kms);
    transaction_params.payment_amount = payment_amount;
    let entity_hash = new casper_rust_wasm_sdk_1.AddressableEntityHash(entity_hash_hex_string);
    let builder_params = casper_rust_wasm_sdk_1.TransactionBuilderParams.newInvocableEntity(entity_hash, 'set_variables');
    const transaction = sdk.make_transaction(builder_params, transaction_params);
...
const example1_legacy = async () => {
    const deploy_hash_as_string = '4ea826ecae4a3b02dc8627c36c7115539c8aac9b73551fffab3f98fc47fd0499';
    const finalized_approvals = true;
...
const example5_legacy = async () => {
    ...
    const transfer_amount = '2500000000';
    const target_account = '01868e06026ba9c8695f6f3bb10d44782004dbc144ff65017cf484436f9cf7b0f6';
    const deploy_params = new casper_rust_wasm_sdk_1.DeployStrParams(chain_name, public_key, secret_key, timestamp, ttl);
    const payment_params = new casper_rust_wasm_sdk_1.PaymentStrParams(payment_amount);
    const transfer_deploy = sdk.make_transfer(transfer_amount, target_account, undefined, // transfer_id
...
-----END PRIVATE KEY-----`;
    ...
    const deploy_params = new casper_rust_wasm_sdk_1.DeployStrParams(chain_name, public_key, secret_key, timestamp, ttl);
    const payment_params = new casper_rust_wasm_sdk_1.PaymentStrParams(payment_amount);
    const transfer_result = await sdk.transfer(transfer_amount, target_account, undefined, // transfer_id
    deploy_params, payment_params);
...
const example7_legacy = async () => {
    ...
    const public_key = '01aff5c18a954604dd27d139d8e0cfc533ac3d53784d76c7a7ac5ff4039510fdf6';
    const payment_amount = '5000000000';
    const contract_hash = 'hash-5be5b0ef09a7016e11292848d77f539e55791cb07a7012fbc336b1f92a4fe743';
    const deploy_params = new casper_rust_wasm_sdk_1.DeployStrParams(chain_name, public_key);
    const session_params = new casper_rust_wasm_sdk_1.SessionStrParams();
...
-----END PRIVATE KEY-----`;
    ...
    const payment_amount = '5000000000';
    const contract_hash = 'hash-5be5b0ef09a7016e11292848d77f539e55791cb07a7012fbc336b1f92a4fe743';
    const deploy_params = new casper_rust_wasm_sdk_1.DeployStrParams(chain_name, public_key, secret_key);
    const session_params = new casper_rust_wasm_sdk_1.SessionStrParams();
    session_params.session_hash = contract_hash;
    session_params.session_entry_point = 'set_variables';
    const payment_params = new casper_rust_wasm_sdk_1.PaymentStrParams(payment_amount);
...
-----END PRIVATE KEY-----`;
    ...
    const payment_params = new casper_rust_wasm_sdk_1.PaymentStrParams(payment_amount);
    const deploy = casper_rust_wasm_sdk_1.Deploy.withPaymentAndSession(deploy_params, session_params, payment_params);
...
-----END PRIVATE KEY-----`;
    ...
    const deploy_params = new casper_rust_wasm_sdk_1.DeployStrParams(chain_name, public_key, secret_key);
    const payment_params = new casper_rust_wasm_sdk_1.PaymentStrParams(payment_amount);
    const transfer_deploy = casper_rust_wasm_sdk_1.Deploy.withTransfer(transfer_amount, target_account, undefined, // transfer_id
    deploy_params, payment_params);
...
-----END PRIVATE KEY-----`;
    ...
    session_params.session_bytes = casper_rust_wasm_sdk_1.Bytes.fromUint8Array(wasm);
    const install_result = await sdk.install_deploy(deploy_params, session_params, payment_amount);
    const install_result_as_json = install_result.toJson();
    console.log(install_result_as_json.deploy_hash);
    const eventParseResult = await sdk.waitDeploy(events_address, install_result_as_json.deploy_hash);
    const cost = eventParseResult.body?.transaction_processed?.execution_result.Success
        ?.cost;
    //  console.log(eventParseResult.body.transaction_processed);
    console.log(`install cost ${cost}`);
...
-----END PRIVATE KEY-----`;
    const public_key = (0, casper_rust_wasm_sdk_1.publicKeyFromSecretKey)(secret_key);
    const contract_hash = 'hash-7705c58f20c445c605ba1bf5adab66686a8f891879d6012e07fe24c8bf3af3f2';
    const entry_point = 'mint';
    const token_owner = 'account-hash-878985c8c07064e09e67cc349dd21219b8e41942a0adc4bfa378cf0eace32611';
    const payment_amount = '5000000000';
    const deploy_params = new casper_rust_wasm_sdk_1.DeployStrParams(chain_name, public_key, secret_key);
    ...
    const call_entrypoint_deploy_result = await sdk.call_entrypoint_deploy(deploy_params, session_params, payment_amount);
    const call_entrypoint_deploy_result_as_json = call_entrypoint_deploy_result.toJson();
    // watch deploy_hash to trigger callback
    const deploy_hash_results = [
        call_entrypoint_deploy_result_as_json.deploy_hash,
    ];
    const watcher = sdk.watchDeploy(events_address);
    const subscriptions = [];
    const getEventHandlerFn = (deployHash) => {
        const eventHandlerFn = (eventParseResult) => {
    ...
    deploy_hash_results.map(async (deploy_hash) => {
        ...
        const subscription = new casper_rust_wasm_sdk_1.Subscription(deploy_hash, eventHandlerFn);
        subscriptions.push(subscription);
    });
    watcher.subscribe(subscriptions);
    const results = await watcher.start();
...
const example14_legacy = async () => {
    ...
    const contract_hash = 'hash-5be5b0ef09a7016e11292848d77f539e55791cb07a7012fbc336b1f92a4fe743';
    let public_key_kms = '01aff5c18a954604dd27d139d8e0cfc533ac3d53784d76c7a7ac5ff4039510fdf6';
    const deploy_params = new casper_rust_wasm_sdk_1.DeployStrParams(chain_name, public_key_kms);
    const session_params = new casper_rust_wasm_sdk_1.SessionStrParams();
    session_params.session_hash = contract_hash;
    session_params.session_entry_point = 'set_variables';
    const payment_params = new casper_rust_wasm_sdk_1.PaymentStrParams(payment_amount);
