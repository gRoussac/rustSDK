...
export const variables = {
  ...
  state_root_hash_default: 'default_value',
  private_key: 'your_private_key',
  account: 'your_account',
  account_hash: 'initial_account_hash',
  target: 'initial_target',
  block_height: 'initial_block_height',
  block_hash: 'initial_block_hash',
  deploy_hash: 'initial_deploy_hash',
  dictionary_key: 'initial_dictionary_key',
  dictionary_uref: 'initial_dictionary_uref',
  contract_cep78_hash: 'initial_contract_cep78_hash',
