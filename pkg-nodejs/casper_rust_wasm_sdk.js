...
function __wbg_adapter_1019(arg0, arg1, arg2, arg3) {
...
class SDK {
    ...
    */
    speculative_exec_txn_options(options) {
        const ret = wasm.sdk_speculative_exec_txn_options(this.__wbg_ptr, addHeapObject(options));
    ...
    */
    speculative_exec_txn(options) {
        let ptr0 = 0;
        if (!isLikeNone(options)) {
            _assertClass(options, getSpeculativeExecTxnOptions);
            ptr0 = options.__destroy_into_raw();
        }
        const ret = wasm.sdk_speculative_exec_txn(this.__wbg_ptr, ptr0);
        return takeObject(ret);
    }
    /**
    ...
    * @returns {Promise<PutDeployResult>}
    */
    call_entrypoint_legacy(deploy_params, session_params, payment_amount, node_address) {
        _assertClass(deploy_params, DeployStrParams);
        var ptr0 = deploy_params.__destroy_into_raw();
        _assertClass(session_params, SessionStrParams);
        var ptr1 = session_params.__destroy_into_raw();
        ...
        var ptr3 = isLikeNone(node_address) ? 0 : passStringToWasm0(node_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len3 = WASM_VECTOR_LEN;
        const ret = wasm.sdk_call_entrypoint_legacy(this.__wbg_ptr, ptr0, ptr1, ptr2, len2, ptr3, len3);
        return takeObject(ret);
    }
    /**
...
module.exports.__wbg_new_81740750da40724f = function(arg0, arg1) {
    try {
        ...
        var cb0 = (arg0, arg1) => {
            ...
            state0.a = 0;
            try {
                return __wbg_adapter_1019(a, state0.b, arg0, arg1);
            } finally {
                state0.a = a;
            }
        };
...
module.exports.__wbindgen_closure_wrapper4864 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 851, __wbg_adapter_32);
    return addHeapObject(ret);
};

module.exports.__wbindgen_closure_wrapper5620 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 1125, __wbg_adapter_35);
    return addHeapObject(ret);
};
