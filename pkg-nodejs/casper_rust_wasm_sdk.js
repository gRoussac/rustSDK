...
class SDK {
    ...
    */
    speculative_exec_options(options) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.sdk_speculative_exec_options(retptr, this.__wbg_ptr, addHeapObject(options));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    speculative_exec_deploy_options(options) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.sdk_speculative_exec_deploy_options(retptr, this.__wbg_ptr, addHeapObject(options));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
class queryContractDictOptions {
    ...
    */
    get node_address() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_querycontractdictoptions_node_address(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v1;
            if (r0 !== 0) {
...
module.exports.__wbindgen_closure_wrapper4984 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 860, __wbg_adapter_32);
    return addHeapObject(ret);
};

module.exports.__wbindgen_closure_wrapper5730 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 1119, __wbg_adapter_35);
    return addHeapObject(ret);
};
