...
export function __wbg_deploystring_free(a: number): void;
export function __wbg_get_deploystring_Deploy(a: number, b: number): void;
export function __wbg_set_deploystring_Deploy(a: number, b: number, c: number): void;
...
export function __wbg_get_transactionprocessed_transaction_hash(a: number): number;
export function __wbg_set_transactionprocessed_transaction_hash(a: number, b: number): void;
