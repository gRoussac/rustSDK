...
export function wasm_bindgen__convert__closures__invoke1_mut__h76ad593a411e2907(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h7e683a71f55349e1(a: number, b: number, c: number, d: number): void;
