...
impl SDK {
    ...
    #[wasm_bindgen(js_name = "install_txn")]
    pub async fn install_txn_js_alias(
        &self,
...
mod tests {
    ...
    async fn test_install_with_none_values() {
        ...
        // Act
        let result = sdk
            .install_txn(transaction_params, transaction_bytes, None)
            .await;
    ...
    async fn test_install_with_error() {
        ...
        // Act
        let result = sdk
            .install_txn(transaction_params, transaction_bytes.into(), None)
            .await;
