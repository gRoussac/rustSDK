...
export function wasm_bindgen__convert__closures__invoke1_mut__h1fbee5e2f017a86c(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h90ab02b8c2e0114e(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h54ecfcab4fe6ce85(a: number, b: number, c: number, d: number): void;
