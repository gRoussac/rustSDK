...
export function transactionstrparams_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number, w: number, x: number, y: number): number;
...
export function transactionstrparams_output_path(a: number, b: number): void;
export function transactionstrparams_set_output_path(a: number, b: number, c: number): void;
...
export function transaction_isExpired(a: number): number;
