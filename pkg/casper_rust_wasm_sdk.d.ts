...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hae2e6541fe204983: (a: number, b: number) => void;
  readonly closure969_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure1166_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure1174_externref_shim: (a: number, b: number, c: number) => void;
  readonly __externref_table_dealloc: (a: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __externref_table_alloc: () => number;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly __externref_drop_slice: (a: number, b: number) => void;
  readonly closure1724_externref_shim: (a: number, b: number, c: number, d: number) => void;
