...
*/
  static fromFormattedStr(input: string): AddressableEntityHash;
/**
* @returns {string}
*/
  toFormattedString(): string;
...
* @returns {PackageHash}
*/
  static fromFormattedStr(input: string): PackageHash;
/**
* @returns {string}
*/
  toFormattedString(): string;
...
* @returns {Transaction}
*/
  static newTransfer(maybe_source: URef | undefined, target_account: string, amount: string, maybe_id: string | undefined, transaction_params: TransactionStrParams): Transaction;
/**
* @param {string} ttl
* @param {string | undefined} [secret_key]
* @returns {Transaction}
...
* @returns {Transaction}
*/
  withHash(hash: AddressableEntityHash, secret_key?: string): Transaction;
/**
...
* @returns {Transaction}
*/
  withModuleBytes(module_bytes: Bytes, secret_key?: string): Transaction;
/**
* @param {string | undefined} [secret_key]
* @returns {Transaction}
*/
...
*/
  static newSession(transaction_bytes?: Bytes): TransactionBuilderParams;
/**
...
* @returns {TransactionBuilderParams}
*/
  static newTransfer(target: TransferTarget, amount: string, maybe_source?: URef, maybe_id?: bigint): TransactionBuilderParams;
/**
* @param {string} entity_hash
* @param {string} entry_point
* @returns {TransactionBuilderParams}
*/
  static newInvocableEntity(entity_hash: string, entry_point: string): TransactionBuilderParams;
/**
...
* @returns {TransactionBuilderParams}
*/
  static newPackage(package_hash: string, entry_point: string, maybe_entity_version?: string): TransactionBuilderParams;
/**
...
* @returns {TransactionBuilderParams}
*/
  static newAddBid(public_key: PublicKey, delegation_rate: number, amount: string): TransactionBuilderParams;
/**
...
* @returns {TransactionHash}
*/
  static fromDigest(digest: Digest): TransactionHash;
/**
* @returns {Digest}
*/
  digest(): Digest;
...
*/
  constructor(chain_name: string, initiator_addr?: string, secret_key?: string, timestamp?: string, ttl?: string, session_args_simple?: (string)[], session_args_json?: string, pricing_mode?: string, payment_amount?: string, gas_price_tolerance?: string, receipt?: string, standard_payment?: boolean);
/**
*/
  setDefaultTimestamp(): void;
/**
...
export interface InitOutput {
  ...
  readonly packagehash_fromString: (a: number, b: number, c: number) => void;
  ...
  readonly transactionstrparams_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number, w: number) => number;
  ...
  readonly transactionstrparams_set_pricing_mode: (a: number, b: number, c: number) => void;
  ...
  readonly transactionstrparams_pricing_mode: (a: number, b: number) => void;
  ...
  readonly sdk_get_entity_options: (a: number, b: number) => number;
  ...
  readonly __wbg_get_getspeculativeexecdeployoptions_maybe_block_id_as_string: (a: number, b: number) => void;
  readonly __wbg_set_getspeculativeexecdeployoptions_maybe_block_id_as_string: (a: number, b: number, c: number) => void;
  readonly __wbg_get_getspeculativeexecdeployoptions_maybe_block_identifier: (a: number) => number;
  readonly __wbg_set_getspeculativeexecdeployoptions_maybe_block_identifier: (a: number, b: number) => void;
  ...
  readonly sdk_speculative_exec_deploy_options: (a: number, b: number) => number;
  ...
  readonly addressableentityhash_fromString: (a: number, b: number, c: number) => void;
  ...
  readonly transactionhash_new: (a: number, b: number, c: number) => void;
  readonly transactionhash_fromRaw: (a: number, b: number, c: number) => void;
  readonly transactionhash_fromDigest: (a: number, b: number) => void;
  ...
  readonly sdk_query_balance_details_options: (a: number, b: number) => number;
  ...
  readonly transactionbuilderparams_newSession: (a: number) => number;
  readonly transactionbuilderparams_newTransfer: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  readonly transactionbuilderparams_newInvocableEntity: (a: number, b: number, c: number, d: number) => number;
  readonly transactionbuilderparams_newInvocableEntityAlias: (a: number, b: number, c: number, d: number) => number;
  readonly transactionbuilderparams_newPackage: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  readonly transactionbuilderparams_newPackageAlias: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  readonly transactionbuilderparams_newAddBid: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly transaction_withHash: (a: number, b: number, c: number, d: number) => number;
  readonly transaction_withPackageHash: (a: number, b: number, c: number, d: number) => number;
  readonly transaction_withModuleBytes: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly transaction_isNative: (a: number) => number;
  readonly transaction_isStandardPayment: (a: number) => number;
  ...
  readonly transaction_entryPoint: (a: number, b: number) => void;
  ...
  readonly transaction_addArg: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly sdk_get_transaction_options: (a: number, b: number) => number;
  ...
  readonly __wbg_get_getspeculativeexectxnoptions_maybe_block_id_as_string: (a: number, b: number) => void;
  readonly __wbg_set_getspeculativeexectxnoptions_maybe_block_id_as_string: (a: number, b: number, c: number) => void;
  readonly __wbg_get_getspeculativeexectxnoptions_maybe_block_identifier: (a: number) => number;
  readonly __wbg_set_getspeculativeexectxnoptions_maybe_block_identifier: (a: number, b: number) => void;
  ...
  readonly sdk_speculative_exec_transaction_options: (a: number, b: number) => number;
  readonly sdk_speculative_exec_transaction: (a: number, b: number) => number;
  ...
  readonly __wbg_deploystring_free: (a: number) => void;
  readonly __wbg_get_deploystring_Deploy: (a: number, b: number) => void;
  readonly __wbg_set_deploystring_Deploy: (a: number, b: number, c: number) => void;
  ...
  readonly __wbg_get_transactionprocessed_transaction_hash: (a: number) => number;
  readonly __wbg_set_transactionprocessed_transaction_hash: (a: number, b: number) => void;
  ...
  readonly __wbg_get_body_TransactionProcessed: (a: number) => number;
  readonly __wbg_set_body_TransactionProcessed: (a: number, b: number) => void;
  ...
  readonly privateToPublicKey: (a: number, b: number, c: number) => void;
  readonly generatePrivateKey: (a: number) => void;
  readonly generatePrivateKey_secp256k1: (a: number) => void;
  readonly accountHashToBase64: (a: number, b: number, c: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd85a22a4c3a67bc6: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h90d8dcd331796d53: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h36bc72dc022e6a31: (a: number, b: number, c: number, d: number) => void;
}
