...
export interface InitOutput {
  ...
  readonly sdk_watch_deploy: (a: number, b: number, c: number, d: number, e: number) => number;
  ...
  readonly generatePrivateKey: () => number;
  readonly generatePrivateKey_secp256k1: () => number;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha1c2fd92839e5bbc: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha64d543ae2213c33: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h5c301d4b90da219f: (a: number, b: number, c: number, d: number) => void;
}
