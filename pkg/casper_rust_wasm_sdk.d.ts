...
export interface InitOutput {
    ...
    readonly __wbg_get_apiversionevent_apiVersion: (a: number, b: number) => void;
    readonly __wbg_get_body_transaction_processed: (a: number) => number;
    readonly __wbg_get_cesevent_contractHash: (a: number, b: number) => void;
    readonly __wbg_get_cesevent_contractPackageHash: (a: number, b: number) => void;
    readonly __wbg_get_cesevent_dataJson: (a: number, b: number) => void;
    readonly __wbg_get_cesevent_eventId: (a: number) => bigint;
    readonly __wbg_get_cesevent_name: (a: number, b: number) => void;
    readonly __wbg_get_cesevent_transformIdx: (a: number) => number;
    readonly __wbg_get_cesparseresult_error: (a: number, b: number) => void;
    readonly __wbg_get_cesparseresult_event: (a: number) => number;
    ...
    readonly __wbg_get_getdictionaryitemoptions_rpc_address: (a: number, b: number) => void;
    ...
    readonly __wbg_get_getrewardoptions_maybe_era_id: (a: number, b: number) => void;
    readonly __wbg_get_getrewardoptions_maybe_era_id_as_string: (a: number, b: number) => void;
    readonly __wbg_get_getrewardoptions_rpc_address: (a: number, b: number) => void;
    readonly __wbg_get_getrewardoptions_validator_public_key: (a: number) => number;
    readonly __wbg_get_getrewardoptions_validator_public_key_as_string: (a: number, b: number) => void;
    readonly __wbg_get_getrewardoptions_verbosity: (a: number) => number;
    ...
    readonly __wbg_get_queryglobalstateoptions_rpc_address: (a: number, b: number) => void;
    ...
    readonly __wbg_getrewardoptions_free: (a: number, b: number) => void;
    ...
    readonly __wbg_set_cesevent_contractHash: (a: number, b: number, c: number) => void;
    readonly __wbg_set_cesevent_contractPackageHash: (a: number, b: number, c: number) => void;
    readonly __wbg_set_cesevent_dataJson: (a: number, b: number, c: number) => void;
    readonly __wbg_set_cesevent_eventId: (a: number, b: bigint) => void;
    readonly __wbg_set_cesevent_name: (a: number, b: number, c: number) => void;
    readonly __wbg_set_cesevent_transformIdx: (a: number, b: number) => void;
    readonly __wbg_set_cesparseresult_error: (a: number, b: number, c: number) => void;
    readonly __wbg_set_cesparseresult_event: (a: number, b: number) => void;
    ...
    readonly __wbg_set_getrewardoptions_maybe_era_id: (a: number, b: number, c: bigint) => void;
    readonly __wbg_set_getrewardoptions_maybe_era_id_as_string: (a: number, b: number, c: number) => void;
    readonly __wbg_set_getrewardoptions_rpc_address: (a: number, b: number, c: number) => void;
    readonly __wbg_set_getrewardoptions_validator_public_key: (a: number, b: number) => void;
    readonly __wbg_set_getrewardoptions_validator_public_key_as_string: (a: number, b: number, c: number) => void;
    readonly __wbg_set_getrewardoptions_verbosity: (a: number, b: number) => void;
    ...
    readonly accessrights_try_from_u8: (a: number) => number;
    ...
    readonly cesevent_data: (a: number, b: number) => void;
    readonly cesparser_contractCount: (a: number) => number;
    readonly cesparser_new: () => number;
    readonly cesparser_parseExecutionResultJson: (a: number, b: number, c: number, d: number) => void;
    readonly cesparser_schemasJson: (a: number, b: number) => void;
    readonly cesparseresult_toJson: (a: number, b: number) => void;
    readonly clvalue_fromBool: (a: number, b: number) => void;
    readonly clvalue_fromBytes: (a: number, b: number) => void;
    readonly clvalue_fromI32: (a: number, b: number) => void;
    readonly clvalue_fromI64: (a: number, b: bigint) => void;
    readonly clvalue_fromKey: (a: number, b: number) => void;
    readonly clvalue_fromPublicKey: (a: number, b: number) => void;
    readonly clvalue_fromString: (a: number, b: number, c: number) => void;
    readonly clvalue_fromU128: (a: number, b: number, c: number) => void;
    readonly clvalue_fromU256: (a: number, b: number, c: number) => void;
    readonly clvalue_fromU32: (a: number, b: number) => void;
    readonly clvalue_fromU512: (a: number, b: number, c: number) => void;
    readonly clvalue_fromU64: (a: number, b: bigint) => void;
    readonly clvalue_fromU8: (a: number, b: number) => void;
    ...
    readonly getrewardresult_api_version: (a: number) => number;
    readonly getrewardresult_delegation_rate: (a: number) => number;
    readonly getrewardresult_era_id: (a: number) => number;
    readonly getrewardresult_reward_amount: (a: number) => number;
    readonly getrewardresult_switch_block_hash: (a: number) => number;
    readonly getrewardresult_toJson: (a: number) => number;
    ...
    readonly paymentstrparams_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number) => number;
    ...
    readonly paymentstrparams_set_payment_args_simple: (a: number, b: number, c: number) => void;
    ...
    readonly rawevent_parseAsApiVersion: (a: number, b: number) => void;
    readonly rawevent_parseAsBlockAdded: (a: number, b: number) => void;
    readonly rawevent_parseAsDeployAccepted: (a: number, b: number) => void;
    readonly rawevent_parseAsDeployExpired: (a: number, b: number) => void;
    readonly rawevent_parseAsDeployProcessed: (a: number, b: number) => void;
    readonly rawevent_parseAsFault: (a: number, b: number) => void;
    readonly rawevent_parseAsFinalitySignature: (a: number, b: number) => void;
    readonly rawevent_parseAsStep: (a: number, b: number) => void;
    readonly rawevent_parseAsTransactionAccepted: (a: number, b: number) => void;
    readonly rawevent_parseAsTransactionExpired: (a: number, b: number) => void;
    readonly rawevent_parseAsTransactionProcessed: (a: number, b: number) => void;
    readonly rawevent_payloadJson: (a: number, b: number, c: number, d: number) => void;
    readonly recordid_new_js_alias: (a: number, b: number) => void;
    readonly runtimeargs_insert: (a: number, b: number, c: number, d: number) => void;
    readonly runtimeargs_insertJsValue: (a: number, b: number, c: number) => void;
    readonly runtimeargs_insertSimple: (a: number, b: number, c: number, d: number) => void;
    readonly runtimeargs_new: () => number;
    readonly runtimeargs_toJson: (a: number) => number;
    readonly runtimeargs_toSessionArgsJson: (a: number, b: number) => void;
    readonly sdk_CES_parser: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
    ...
    readonly sdk_get_binary_block_header_by_height: (a: number, b: bigint, c: number, d: number) => number;
    readonly sdk_get_binary_block_synchronizer_status: (a: number, b: number, c: number) => number;
    readonly sdk_get_binary_block_with_signatures_by_hash: (a: number, b: number, c: number, d: number) => number;
    readonly sdk_get_binary_block_with_signatures_by_height: (a: number, b: bigint, c: number, d: number) => number;
    ...
    readonly sdk_get_binary_delegator_reward_by_block_height: (a: number, b: number, c: number, d: bigint, e: number, f: number) => number;
    ...
    readonly sdk_get_binary_global_state_item_by_block_height: (a: number, b: bigint, c: number, d: number, e: number, f: number, g: number) => number;
    ...
    readonly sdk_get_binary_latest_block_with_signatures: (a: number, b: number, c: number) => number;
    ...
    readonly sdk_get_binary_validator_reward_by_block_height: (a: number, b: number, c: bigint, d: number, e: number) => number;
    ...
    readonly sdk_get_reward: (a: number, b: number) => number;
    readonly sdk_get_reward_options: (a: number, b: number, c: number) => void;
    ...
    readonly sdk_info_get_reward: (a: number, b: number) => number;
    ...
    readonly sessionstrparams_set_session_args: (a: number, b: number) => void;
    readonly sessionstrparams_set_session_args_json: (a: number, b: number, c: number) => void;
    readonly sessionstrparams_set_session_args_simple: (a: number, b: number, c: number) => void;
    ...
    readonly signatureresponse_get_signature: (a: number, b: number) => void;
    readonly signatureresponse_get_signature_hex: (a: number, b: number) => void;
    ...
    readonly transaction_payment_amount: (a: number, b: number) => void;
    ...
    readonly transactionstrparams_additional_computation_factor: (a: number, b: number) => void;
    ...
    readonly transactionstrparams_session_entry_point: (a: number, b: number) => void;
    ...
    readonly transactionstrparams_set_session_args: (a: number, b: number) => void;
