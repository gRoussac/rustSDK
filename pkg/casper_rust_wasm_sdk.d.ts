...
export interface InitOutput {
  ...
  readonly closure986_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__hc3623df83801f1ca: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h42a561e500a36af0: (a: number, b: number) => void;
  readonly closure1201_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1751_externref_shim: (a: number, b: number, c: any, d: any) => void;
