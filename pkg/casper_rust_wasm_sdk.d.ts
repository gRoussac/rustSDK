...
* @returns {Promise<any>}
*/
  get_binary_latest_block_with_signatures(node_address?: string): Promise<any>;
/**
* @param {bigint} height
* @param {string | undefined} [node_address]
* @returns {Promise<any>}
*/
  get_binary_block_with_signatures_by_height(height: bigint, node_address?: string): Promise<any>;
/**
* @param {BlockHash} block_hash
* @param {string | undefined} [node_address]
* @returns {Promise<any>}
*/
  get_binary_block_with_signatures_by_hash(block_hash: BlockHash, node_address?: string): Promise<any>;
/**
...
* @returns {TransactionBuilderParams}
*/
  static newPackageWithMajor(package_hash: PackageHash, entry_point: string, maybe_entity_version?: string, major_protocol_version?: number): TransactionBuilderParams;
/**
...
* @returns {TransactionBuilderParams}
*/
  static newPackageAliasWithMajor(package_alias: string, entry_point: string, maybe_entity_version?: string, major_protocol_version?: number): TransactionBuilderParams;
/**
* @param {PublicKey} public_key
...
* @param {boolean | undefined} [min_bid_override]
*/
  constructor(chain_name: string, initiator_addr?: string, secret_key?: string, timestamp?: string, ttl?: string, session_args_simple?: (string)[], session_args_json?: string, pricing_mode?: PricingMode, additional_computation_factor?: string, payment_amount?: string, gas_price_tolerance?: string, receipt?: string, standard_payment?: boolean, transferred_value?: string, session_entry_point?: string, chunked_args?: Bytes, min_bid_override?: boolean);
/**
* @param {string} chain_name
* @param {string | undefined} [initiator_addr]
* @param {string | undefined} [secret_key]
...
export interface InitOutput {
  ...
  readonly transactionbuilderparams_newPackageWithMajor: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
  readonly transactionbuilderparams_newPackageAlias: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  readonly transactionbuilderparams_newPackageAliasWithMajor: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
  readonly transactionbuilderparams_newAddBid: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => number;
  ...
  readonly transactionbuilderparams_set_minimum_delegation_amount: (a: number, b: number, c: number) => void;
  readonly transactionbuilderparams_maximum_delegation_amount: (a: number, b: number) => void;
  readonly transactionbuilderparams_set_maximum_delegation_amount: (a: number, b: number, c: number) => void;
  ...
  readonly sdk_get_binary_block_with_signatures_by_height: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0eeb8717e51f2476: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3c0e2a843ce30347: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h94df0cafff516233: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h0d671320839048d3: (a: number, b: number, c: number, d: number) => void;
}
