...
export class SDK {
  ...
  get_binary_latest_signed_block(node_address?: string | null): Promise<any>;
  get_binary_signed_block_by_height(height: bigint, node_address?: string | null): Promise<any>;
  get_binary_signed_block_by_hash(block_hash: BlockHash, node_address?: string | null): Promise<any>;
...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h17a1ba4a22b711ef: (a: number, b: number) => void;
  readonly closure978_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1148_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1191_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1760_externref_shim: (a: number, b: number, c: any, d: any) => void;
