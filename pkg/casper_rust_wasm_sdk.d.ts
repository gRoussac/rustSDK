...
* @returns {Promise<GetValidatorChangesResult>}
*/
  info_get_validator_changes(verbosity?: Verbosity, node_address?: string): Promise<GetValidatorChangesResult>;
/**
...
export interface InitOutput {
  ...
  readonly entityidentifier_new: (a: number, b: number, c: number) => void;
  ...
  readonly sdk_info_get_validator_changes: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h01883b904c431d19: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9f39d37b1d34b2e6: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h0cd43d8abe90f6d4: (a: number, b: number, c: number, d: number) => void;
}
