...
* @returns {any}
*/
  make_deploy(deploy_params: DeployStrParams, session_params: SessionStrParams, payment_params: PaymentStrParams, force: boolean): any;
/**
...
export interface InitOutput {
  ...
  readonly sdk_make_deploy: (a: number, b: number, c: number, d: number, e: number) => number;
