...
* @returns {Bytes}
*/
  static fromSlice(slice: Uint8Array): Bytes;
/**
* @returns {Array<any>}
*/
  iter(): Array<any>;
...
*/
  static withSession(deploy_params: DeployStrParams, session_params: SessionStrParams, payment_params: PaymentStrParams): Deploy | undefined;
/**
* @param {string} amount
...
* @returns {Deploy | undefined}
*/
  static withTransfer(amount: string, target_account: string, transfer_id: string | undefined, deploy_params: DeployStrParams, payment_params: PaymentStrParams): Deploy | undefined;
/**
* @returns {boolean}
*/
...
export interface InitOutput {
  ...
  readonly deploy_withSession: (a: number, b: number, c: number) => number;
  ...
  readonly bytes_len: (a: number) => number;
  readonly bytes_is_empty: (a: number) => number;
  readonly bytes_push: (a: number, b: number) => void;
  readonly bytes_extend: (a: number, b: number, c: number) => void;
  readonly bytes_asSlice: (a: number) => number;
  readonly bytes_fromSlice: (a: number, b: number) => number;
  readonly bytes_iter: (a: number) => number;
  ...
  readonly bytes_innerBytes: (a: number) => number;
