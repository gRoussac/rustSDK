...
export interface InitOutput {
  ...
  readonly __wbg_accountnamedkey_free: (a: number) => void;
  readonly __wbg_urefvariant_free: (a: number) => void;
  readonly __wbg_dictionaryvariant_free: (a: number) => void;
  readonly __wbg_dictionaryitemstrparams_free: (a: number) => void;
  readonly __wbg_contractnamedkey_free: (a: number) => void;
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h40c7eb4c2cbb51ab: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h161e9520129f1928: (a: number, b: number, c: number, d: number) => void;
}
