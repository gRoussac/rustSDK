...
export function __wbg_querycontractoptions_free(a: number): void;
export function sdk_query_contract_options(a: number, b: number): number;
export function sdk_query_contract(a: number, b: number): number;
