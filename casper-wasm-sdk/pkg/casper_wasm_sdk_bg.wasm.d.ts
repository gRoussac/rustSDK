...
export function accounthash_new(a: number, b: number): void;
...
export function dictionaryaddr_to_vec(a: number, b: number): void;
...
export function hashaddr_to_vec(a: number, b: number): void;
...
export function sdk_get_account(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
...
export function urefaddr_to_vec(a: number, b: number): void;
