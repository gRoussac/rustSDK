...
export function deploy_addArg(a: number, b: number, c: number, d: number, e: number, f: number): number;
...
export function wasm_bindgen__convert__closures__invoke1_mut__h9de327c1e2e0fdcd(a: number, b: number, c: number): void;
