...
export function __wbg_get_querycontractkeyoptions_global_state_identifier_as_string(a: number, b: number): void;
export function __wbg_set_querycontractkeyoptions_global_state_identifier_as_string(a: number, b: number, c: number): void;
...
export function sdk_speculative_transfer(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number): number;
...
export function __wbg_get_querycontractdictoptions_global_state_identifier_as_string(a: number, b: number): void;
export function __wbg_set_querycontractdictoptions_global_state_identifier_as_string(a: number, b: number, c: number): void;
export function __wbg_get_querycontractdictoptions_global_state_identifier(a: number): number;
export function __wbg_set_querycontractdictoptions_global_state_identifier(a: number, b: number): void;
...
export function __wbg_get_querycontractdictoptions_maybe_block_id_as_string(a: number, b: number): void;
export function __wbg_set_querycontractdictoptions_maybe_block_id_as_string(a: number, b: number, c: number): void;
